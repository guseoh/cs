...
기존 VPC와 public subnet을 사용했고, 신규 NAT Gateway나 Load Balancer는 만들지 않았다. EC2가 package, Docker Hub와 public GHCR을 직접 pull할 수 있는 outbound internet 경로를 사용했다. 이 구조는 단순하지만 EC2와 public IPv4 비용, host 방어와 patch 책임이 운영자에게 남는다.
