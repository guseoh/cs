...
Event-driven을 그대로 번역하면 **이벤트 기반**이고, 여기서 Event는 “이 연결에서 읽을 데이터가 생겼다”, “새 연결이 들어왔다”, “이 Socket에 데이터를 쓸 수 있다”처럼 **지금 처리할 일이 생겼다는 사건**을 의미한다. [논-블로킹(non-blocking) I/O, 비동기(Asynchronous) I/O 차이 이해하기](https://grip.news/archives/1304/)
